...
class StonesAndWeights {
    ...
    /*logic : Basically at each attempt, we need to pick 2 heaviest stones and smash them, store the remaining weight. So insert all the values in max heap. pick two at each time till only one is left*/   
